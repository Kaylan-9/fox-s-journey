...
function player:updateFrame(dt, balloon_message)
  ...
  if ((pressed.mov or pressed.run or pressed.jump ) and balloon_message==true) or (self.jump.reached==true) or (love.keyboard.isDown("up", "w")==false and self.p.y<self.p.f.y) then
