...
function ObjectManager:load()
  ...
  self:addObject(Block(self:getList('objects'), {x=500, y=550}))
  self:addObject(Block(self:getList('objects'), {x=564, y=550}))
  self:addObject(Block(self:getList('objects'), {x=628, y=550}))
  self:addObject(Block(self:getList('objects'), {x=692, y=525}))
  self:addObject(Block(self:getList('objects'), {x=756, y=550}))
  self:addObject(Block(self:getList('objects'), {x=810, y=525}))
  self:addObject(Block(self:getList('objects'), {x=874, y=500}))
  self:addObject(Block(self:getList('objects'), {x=938, y=475}))
  self:addObject(Block(self:getList('objects'), {x=1002, y=425}))
  self:addObject(Block(self:getList('objects'), {x=1066, y=375}))
